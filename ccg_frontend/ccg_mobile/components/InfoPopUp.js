    ...
    <View style={styles.popupContainer}>
      ...
      <View style={styles.amenitiesContainer}>
        <View style={styles.amenity}>
          <Ionicons
            name={value.parking_lot ? "car" : "close-circle"}
            size={20}
            color={value.parking_lot ? "green" : "red"}
          />
        ...
        <View style={styles.amenity}>
          <Ionicons
            name={value.accessibility ? "accessibility" : "close-circle"}
            size={20}
            color={value.accessibility ? "green" : "red"}
          />
        ...
        <View style={styles.amenity}>
          <Ionicons
            name={value.atm ? "cash-outline" : "close-circle"}
            size={20}
            color={value.atm ? "green" : "red"}
          />
