...
def test_get_indoor_direction_data():
    ...
    assert data == {'floor_sequence': ['H8'], 'path_data': {'H8': 'M160 200 L180 220 L180 220 L555 220 L555 800 L675 800 L675 820'}, 'pin': {'H8': [[75, 105], [640, 900]]}}
    data = get_indoor_directions_data("H867", "H913")
    assert data == {'floor_sequence': ['H8', 'H9'], 'path_data': {'H8': 'M160 200 L180 220 L180 400 L275 400 L275 380', 'H9': 'M265 385 L265 405 L530 405 L530 225 L705 225 L705 200'}, 'pin': {'H8': [[75, 105], [250, 320]], 'H9': [[265, 340], [740, 120]]}}