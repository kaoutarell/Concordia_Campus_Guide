...
class PointOfInterestViewsTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.poi1 = PointOfInterest.objects.create(name="Restaurant1", category="restaurant", campus="SGW", location="POINT(-73.5788 45.4971)")
        self.poi2 = PointOfInterest.objects.create(name="Cafe1", category="cafe", campus="LOY", location="POINT(-73.579 45.4973)")
        self.poi3 = PointOfInterest.objects.create(name="Cafe2", category="cafe", campus="SGW", location="POINT(-73.5788 45.4971)")
        self.poi4 = PointOfInterest.objects.create(name="FastFood1", category="fast_food", campus="LOY", location="POINT(-73.579 45.4973)")
