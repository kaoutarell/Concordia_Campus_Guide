...
def get_points_of_interest(request):
    ...
    if longitude and latitude:
        ...
        user_location = Point(longitude, latitude, srid=4326)  # Ensure SRID matches your DB
        points_of_interest = points_of_interest.annotate(distance=Distance('location', user_location)).order_by('distance')
